...
2. Run `python3 ./app/main.py`

Might make some Docker image or setup in the future, who knows

I've updated your [`README.md`](README.md) to reflect the new project structure with Docker support:
...
| `OPENAI_MODEL` | Model name to use (default: qwen3-30b-a3b-2507-instruct-unsloth-settings) |
